...
<div class="container-detached">
    ...
    <div class="panel">
								<div class="panel-body">
									<div class="content-group-lg">
										...
										<ul class="list-inline list-inline-separate text-muted content-group">
											...
											<li><a  class="text-muted">{{count($blogsSingle->Comments)}}  comments</a></li>
                                            <li><a  class="text-muted">{{$blogsSingle->count_views}} Views</a></li>
										</ul>
							...
							<div class="panel panel-flat">
										...
										<li class="media">
											...
											<div class="media-body">
												...
												@if(auth()->check() && auth()->user()->id ==$item->user->id)
													...
													<li>
													{!! Form::open(['route' => ['user.blog.user.comments.delete',$item->id], 'method' => 'delete' ,'name' => 'my-form-'.$item->id]) !!}
								...
								{!! Form::open(['route' => ['user.blog.user.comments.edit',['commentId' => $item->id , 'blogid' => $blogsSingle->id] ], 'method' => 'PUT']) !!}
								...
								{!! Form::open(['route' => ['user.blog.user.comments.store',$blogsSingle->id ], 'method' => 'POST']) !!}
