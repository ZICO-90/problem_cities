...
window.Echo.join('online').here(function (users) {
  users.forEach(function (user) {
    $('#media-list').append("\n            <li class=\"media\" id=\"media-".concat(user.id, "\">\n                                        \n                                        <div class=\"media-link\">\n                                            <div class=\"media-left\"><img src=\"/Users/Picture/").concat(user.avatar, "\" class=\"img-circle img-md\" alt=\"\"></div>\n                                            <div class=\"media-body\">\n                                                <span class=\"media-heading text-semibold\">").concat(user.name, "</span>\n                                            \n                                            </div>\n                                            <div class=\"media-right media-middle\">\n                                                <span class=\"status-mark bg-success\"></span>\n                                            </div>\n                                        </div>\n                                    </li>\n    \n            \n            "));
  });
  console.log(users);
...
$(document).on("keypress.key102", function (event) {
  if ($('#enter-message-chat').is(':visible')) {
    if (event.which == 13) {
      ...
      var ms = $('#enter-message-chat').val();
      var avatar = $('meta[name=avatar]').attr('content');

      var _user_id = $('meta[name=user_id]').attr('content');

      $('#chat-list-message').append("\n                <li class=\"media reversed\" id=\"media-reversed\">\n\t\t\t\t\t\t\t\t\t<div class=\"media-body\">\n\t\t\t\t\t\t\t\t\t\t<div class=\"media-content\">".concat(ms, "</div>\n\t\t\t\t\t\t\t\t\t\t<span class=\"media-annotation display-block mt-10\">").concat(new Date(date).getHours(), " :  ").concat(new Date(date).getUTCMinutes(), "<a href=\"#\"><i class=\"icon-pin-alt position-right text-muted\"></i></a></span>\n\t\t\t\t\t\t\t\t\t</div>\n\n\t\t\t\t\t\t\t\t\t<div class=\"media-right\">\n\t\t\t\t\t\t\t\t\t\t<a href=\"../../../../global_assets/images/placeholders/placeholder.jpg\">\n\t\t\t\t\t\t\t\t\t\t\t<img src=\"/Users/Picture/").concat(avatar, "\" class=\"img-circle img-md\" alt=\"\">\n\t\t\t\t\t\t\t\t\t\t</a>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</li>\n                "));
      var data = {
...
window.Echo.channel('laravel_database_chat-group').listen('MessagesDelivered', function (event) {
  console.log(event);
  $('#chat-list-message').append("\n        <li class=\"media\" id=\"media-text\">\n        <div class=\"media-left\">\n            <a >\n                <img src=\"/Users/Picture/".concat(event.messages.user.avatar, "\" class=\"img-circle img-md\" alt=\"\">\n            </a>\n        </div>\n\n        <div class=\"media-body\">\n            <div class=\"media-content\">").concat(event.messages.message, "</div>\n            <span class=\"media-annotation display-block mt-10\">").concat(new Date(event.messages.created_at).getHours(), " :  ").concat(new Date(event.messages.created_at).getUTCMinutes(), "  <a href=\"#\"><i class=\"icon-pin-alt position-right text-muted\"></i></a></span>\n        </div>\n    </li>\n\n        "));
});
var user_id = $('meta[name=layout_user_id]').attr('content');
window.Echo.channel('laravel_database_status-problem.' + user_id).listen('StatusProblemEvents', function (event) {
  document.getElementById("count-notify-refresh").innerHTML = event.counts;
  $('#list-notify-refresh').append("\n        <li class=\"media\">\n        <div class=\"media-left\">\n        <i class=\"btn border-warning text-warning btn-flat btn-rounded btn-icon btn-sm\"><i class=\"icon-git-commit\"></i></i>\n        </div>\n\n        <div class=\"media-body\">\n            <a href=\"/user/problems/detail/".concat(event.status.id, "\" class=\"media-heading\">\n                <span class=\"text-semibold\">\u0627\u0633\u0645 \u0627\u0644\u062E\u0644\u0644 :  ").concat(event.status.problem_name, "</span>\n                <span class=\"media-annotation pull-right\"> ").concat(new Date(event.status.created_at).getHours(), " :  ").concat(new Date(event.status.created_at).getUTCMinutes(), "  </span>\n            </a>\n\n            <span class=\"text-muted\">\u062D\u0627\u0644\u0629 \u0627\u0644\u0627\u062E\u0644\u0644 \u0627\u0644\u0627\u0646 :  ").concat(event.status.order_status, " </span>\n        </div>\n    </li>\n\n        "));
});
console.log('App.Models.User.' + user_id);
window.Echo.channel('laravel_database_private-App.Models.User.' + user_id).notification(function (notification) {
  if (notification.type === 'broadcast.message') {
    ...
    $('#list-notify-refresh').append("\n       \n            <li class=\"media\">\n                                    <div class=\"media-left\">\n                                    <i class=\"btn border-primary text-primary btn-flat btn-rounded btn-icon btn-sm\"><i class=\"icon-git-commit\"></i></i>\n                                    </div>\n    \n                                    <div class=\"media-body\">\n                                    <a href=\"/user/problems/detail/".concat(notification.problem_id, "\" class=\"media-heading\">\n                                            <span class=\"text-semibold\">\u062A\u0645 \u0627\u0636\u0627\u0641\u0629 \u062E\u0644\u0644 \u0628\u0648\u0627\u0633\u0637\u0629 - ").concat(notification.user_name, "</span>\n                                            <span class=\"text-semibold\">\u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u062E\u0644\u0644 : ").concat(notification.problem_name, "</span>\n                                            <span class=\"media-annotation pull-right\">").concat(new Date(date).getHours(), " :  ").concat(new Date(date).getUTCMinutes(), " </span>\n                                        </a>\n    \n                                        <span class=\"text-muted\">\u062A\u0646\u0628\u064A\u0647 \u0644\u0644\u0623\u062F\u0645\u0646: ").concat(notification.to_admin, "</span>\n                                    </div>\n                                </li>\n    \n            "));
  } else if (notification.type === 'broadcast.comments') {
    console.log(notification);
    document.getElementById("count-notify-refresh").innerHTML = notification.count_notification;
    $('#list-notify-refresh').append("\n       \n            <li class=\"media\">\n                                    <div class=\"media-left\">\n                                    <i class=\"btn border-success text-success btn-flat btn-rounded btn-icon btn-sm\"><i class=\"icon-git-commit\"></i></i>\n                                    </div>\n    \n                                    <div class=\"media-body\">\n                                    <a href=\"/user/problems/detail/".concat(notification.problem_id, "\" class=\"media-heading\">\n                                            <span class=\"text-semibold\">\u062A\u0645 \u0627\u0644\u062A\u0639\u0644\u064A\u0642 \u0628\u0648\u0627\u0633\u0637\u0629 - ").concat(notification.user_name, "</span>\n                                            <span class=\"text-semibold\">\u0639\u0644\u064A \u0627\u0644\u062E\u0644\u0644 \u0627\u0644\u062A\u0627\u0644\u064A : ").concat(notification.problem_name, "</span>\n                                            <span class=\"media-annotation pull-right\">").concat(new Date(date).getHours(), " :  ").concat(new Date(date).getUTCMinutes(), " </span>\n                                        </a>\n    \n                                        <span class=\"text-muted\">\u0627\u0644\u062A\u0639\u0644\u064A\u0642: ").concat(notification.text_comment, "</span>\n                                    </div>\n                                </li>\n    \n            "));
  }
});
/*
